...
public class NoteController extends BaseController
{
     ...
     * 查询笔记列表
     */
    @PreAuthorize("@ss.hasPermi('user:note:list')")
    @GetMapping("/list")
     ...
     * 导出笔记列表
     */
    @PreAuthorize("@ss.hasPermi('user:note:export')")
     ...
     * 获取笔记详细信息
     */
    @PreAuthorize("@ss.hasPermi('user:note:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增笔记
     */
    @PreAuthorize("@ss.hasPermi('user:note:add')")
     ...
     * 修改笔记
     */
    @PreAuthorize("@ss.hasPermi('user:note:edit')")
     ...
     * 删除笔记
     */
    @PreAuthorize("@ss.hasPermi('user:note:remove')")
