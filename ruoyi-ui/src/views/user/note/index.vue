<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="noteList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="笔记编号" prop="id"/>
      <el-table-column align="center" label="点赞数" prop="likeNumber"/>
      <el-table-column align="center" label="评论数" prop="commentNumber"/>
...
<script>
import {addNote, delNote, exportNote, getNote, listNote, updateNote} from "@/api/user/note";
